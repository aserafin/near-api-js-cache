...
},{"./constants":53,"./providers":62,"./transaction":67,"./utils/errors":69,"./utils/exponential-backoff":70,"./utils/key_pair":73,"./utils/rpc_errors":74,"_process":33,"bn.js":3,"borsh":4,"buffer":7}],47:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        ...
        viewMethods.forEach((methodName) => {
            Object.defineProperty(this, methodName, {
                ...
                value: nameFunction(methodName, (args = {}, options = {}, ...ignored) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    return this.account.viewFunction(Object.assign({ contractId: this.contractId, methodName,
                        args }, options));
                }))
            });
        });
    ...
    query(...args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (result && result.error) {
                throw new errors_1.TypedError(`Querying failed: ${result.error}.\n${JSON.stringify(result, null, 2)}`, (0, rpc_errors_1.getErrorTypeFromErrorMessage)(result.error, result.error.name));
            }
            return result;
        });
    }
                ...
                try {
                    ...
                    if (response.error) {
                        if (typeof response.error.data === 'object') {
                            ...
                            throw new errors_1.TypedError(errorMessage, (0, rpc_errors_1.getErrorTypeFromErrorMessage)(response.error.data, response.error.name));
                        }
                    }
